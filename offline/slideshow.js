modelfilestrs['slideshow'] = hereDoc(function(){/*!
	...
	var slideshow = new function() {
		...
		this.sizeChanged = function() {
			if (x_browserInfo.mobile == false) {
				...
				var btnHolderH = $btnHolder.length > 0 ? $btnHolder.outerHeight(true) : 0,
					slideTxtH = $slideTxt.length > 0 ? $slideTxt.outerHeight(true) : 0;
